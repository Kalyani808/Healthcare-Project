    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="space-y-3">
          <div className="w-12 h-12 rounded-2xl bg-health-50 text-health-600 flex items-center justify-center text-xl">
            <FaHandsHelping />
          </div>
          <h3 className="text-lg font-bold text-slate-800">Empathy First</h3>
        ...
        <Card className="space-y-3">
          <div className="w-12 h-12 rounded-2xl bg-mint-50 text-mint-600 flex items-center justify-center text-xl">
            <FaLightbulb />
          </div>
          <h3 className="text-lg font-bold text-slate-800">AI for Good</h3>
          <p className="text-sm text-slate-600">
        ...
        <Card className="space-y-3">
          <div className="w-12 h-12 rounded-2xl bg-tealSoft-50 text-tealSoft-600 flex items-center justify-center text-xl">
            <FaShieldAlt />
          </div>
          <h3 className="text-lg font-bold text-slate-800">Complete Privacy</h3>
          <p className="text-sm text-slate-600">
      ...
      {/* Impact Story */}
      <div className="bg-gradient-to-r from-health-50 to-mint-50 rounded-3xl p-8 sm:p-12 border border-health-100 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="space-y-2">
          <h3 className="text-2xl font-bold text-slate-800">Built for Low-Connectivity & High Impact</h3>
