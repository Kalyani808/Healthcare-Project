      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <Card className="space-y-6">
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100">Direct Contacts</h3>
            
            <div className="flex items-center space-x-4 p-4 bg-health-50 dark:bg-health-950/60 rounded-2xl border border-health-100 dark:border-health-900/60">
              <div className="w-12 h-12 rounded-xl bg-health-500 text-white flex items-center justify-center text-xl shrink-0">
                <FaPhoneAlt />
              </div>
              <div>
                <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Emergency Helpline</span>
                <p className="text-lg font-bold text-slate-800 dark:text-slate-100">104 / 108 (Toll Free)</p>
              </div>
            </div>

            <div className="flex items-center space-x-4 p-4 bg-mint-50 dark:bg-mint-950/60 rounded-2xl border border-mint-100 dark:border-mint-900/60">
              <div className="w-12 h-12 rounded-xl bg-mint-500 text-white flex items-center justify-center text-xl shrink-0">
                <FaEnvelope />
              </div>
              <div>
                <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Support Email</span>
                <p className="text-sm font-bold text-slate-800 dark:text-slate-100">support@sevahealth.org</p>
              </div>
            </div>

            <div className="flex items-center space-x-4 p-4 bg-tealSoft-50 dark:bg-tealSoft-950/60 rounded-2xl border border-tealSoft-100 dark:border-tealSoft-900/60">
              <div className="w-12 h-12 rounded-xl bg-tealSoft-500 text-white flex items-center justify-center text-xl shrink-0">
                <FaMapMarkerAlt />
              </div>
              <div>
                <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Headquarters</span>
                <p className="text-xs font-bold text-slate-800 dark:text-slate-100">SevaHealth Rural Hub, Solan District, HP, India</p>
              </div>
            </div>
          </Card>
        </div>
