...
const LandingPage = () => {
  return (
    <div className="space-y-24 pb-20">
      ...
      <section className="relative overflow-hidden pt-12 lg:pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-health-50 dark:bg-health-950/50 border border-health-200 dark:border-health-800 px-4 py-2 rounded-full text-health-700 dark:text-health-300 text-xs font-semibold shadow-sm">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-800 dark:text-slate-100 leading-[1.15] tracking-tight">
                Quality Healthcare for <span className="bg-gradient-to-r from-health-600 via-tealSoft-600 to-mint-600 dark:from-health-400 dark:via-tealSoft-400 dark:to-mint-400 bg-clip-text text-transparent">Every Village.</span>
              </h1>

              <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed mx-auto lg:mx-0">
              ...
              <div className="pt-6 flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs text-slate-500 dark:text-slate-400 font-medium">
                <div className="flex items-center space-x-2">
                  <FaCheckCircle className="text-mint-500 dark:text-mint-400 text-base" />
                  <span>100% Free Consultation Assistance</span>
                </div>
                <div className="flex items-center space-x-2">
                  <FaShieldAlt className="text-health-500 dark:text-health-400 text-base" />
                  <span>Secure Local Storage</span>
                </div>
                <div className="flex items-center space-x-2">
                  <FaVolumeUp className="text-tealSoft-500 dark:text-tealSoft-400 text-base" />
            ...
            >
              <div className="relative mx-auto max-w-md bg-gradient-to-tr from-white via-health-50 to-mint-50 dark:from-[#172033] dark:via-[#1E293B] dark:to-[#0F172A] p-6 rounded-3xl border border-health-100 dark:border-slate-700/80 shadow-xl shadow-health-100/50 dark:shadow-none">
                
                {/* Floating Doctor Card */}
                <div className="bg-white dark:bg-[#1E293B] p-5 rounded-2xl border border-slate-100 dark:border-slate-700/80 shadow-md mb-4 flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-800 dark:text-slate-100 text-base">Dr. Ananya Sharma</h4>
                    <p className="text-xs text-health-600 dark:text-health-400 font-semibold">General Medicine Specialist</p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Available for Tele-Consultation</p>
                  </div>
                </div>
                ...
                <div className="mt-4 p-4 bg-white/80 dark:bg-[#1E293B]/90 backdrop-blur-sm rounded-2xl border border-slate-100 dark:border-slate-700/80 text-xs text-slate-600 dark:text-slate-300 flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-700 dark:text-slate-200">Ram Singh (Village Sundarpur)</p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">"Uploaded handwritten doctor slip and understood dosage in 10 seconds!"</p>
                  </div>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card hoverable className="space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-health-50 dark:bg-health-950/60 text-health-600 dark:text-health-400 flex items-center justify-center text-2xl">
              <FaFileUpload />
            </div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">AI Prescription Reader</h3>
          ...
          <Card hoverable className="space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-mint-50 dark:bg-mint-950/60 text-mint-600 dark:text-mint-400 flex items-center justify-center text-2xl">
              <FaRobot />
            </div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Voice-Guided Health Sahayak</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <Card hoverable className="space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-tealSoft-50 dark:bg-tealSoft-950/60 text-tealSoft-600 dark:text-tealSoft-400 flex items-center justify-center text-2xl">
              <FaStethoscope />
            </div>
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">Tele-Doctor Consultations</h3>
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
      ...
      {/* How it Works */}
      <section className="bg-slate-50 dark:bg-[#0B1220] py-16 border-y border-slate-100 dark:border-slate-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100">How SevaHealth Works in 3 Steps</h2>
            <p className="text-slate-600 dark:text-slate-300 text-sm">Simple enough for any smartphone or village kiosk.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white dark:bg-[#172033] p-8 rounded-3xl border border-slate-100 dark:border-slate-700/80 shadow-sm space-y-4">
              ...
              <h4 className="font-bold text-slate-800 dark:text-slate-100 text-base">Click a Photo or Speak</h4>
              <p className="text-sm text-slate-600 dark:text-slate-300">Take a photo of your doctor slip or describe your fever, headache, or pain.</p>
            </div>
            ...
            <div className="bg-white dark:bg-[#172033] p-8 rounded-3xl border border-slate-100 dark:border-slate-700/80 shadow-sm space-y-4">
              ...
              <h4 className="font-bold text-slate-800 dark:text-slate-100 text-base">Receive Clear Summary</h4>
              <p className="text-sm text-slate-600 dark:text-slate-300">Get clean, translated medication guidelines and safety instructions instantly.</p>
            </div>
            ...
            <div className="bg-white dark:bg-[#172033] p-8 rounded-3xl border border-slate-100 dark:border-slate-700/80 shadow-sm space-y-4">
              ...
              <h4 className="font-bold text-slate-800 dark:text-slate-100 text-base">Connect with Doctor</h4>
              <p className="text-sm text-slate-600 dark:text-slate-300">Follow up with a certified doctor or share your digital report with family.</p>
            </div>
          </div>
        </div>
      </section>
